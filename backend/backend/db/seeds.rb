...
Artist.create([
    ...
    {name: "Rick Astley", image: "https://images.app.goo.gl/KD3DhEvsozjLUBfeA"},
    ...
    {name: "Beastie Boys", image: "https://images.app.goo.gl/Nx2g4VQkgqvzesGfA"},
    {name: "Epmd", image: "https://images.app.goo.gl/2pmciTQunD4fNHbb6"},
    {name: "LL Cool J", image: "https://images.app.goo.gl/myUUMyMDmvtbpYMYA"},
    {name: "Metallica", image: "https://images.app.goo.gl/HxQw3NjF3tNAExFq7"},
    {name: "Bon Jovi", image: "https://images.app.goo.gl/srWk9QmeWE485KABA"},
    {name: "Queen", image: "https://cdn.shopify.com/s/files/1/0630/8509/products/pst1509queen_grande.jpg?v=1550779195"},
